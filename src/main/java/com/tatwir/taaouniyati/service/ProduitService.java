...
public class ProduitService {
        ...
        // public Page<ProduitDTO> getAllProduitsWithFilter(Long cooperativeId, Long
        // categorieId, int page, int size) {
        ...
        // .orElseThrow(() -> new NotFoundException("Cooperative not found with id: " +
        // cooperativeId));
        //// System.out.p
        ...
        // .orElseThrow(() -> new NotFoundException("Categorie not found with id: " +
        // categorieId));
        ...
        public List<ProduitDTO> getAllProduitsWithFilter(Long cooperativeId, Long categorieId) {
                ...
                if (cooperativeId != null) {
                        Cooperative cooperative = cooperativeRepository.findById(cooperativeId)
                                        .orElseThrow(() -> new NotFoundException(
                                                        "Cooperative not found with id: " + cooperativeId));
                        exampleProduit.setCooperative(cooperative);
                }
                ...
                if (categorieId != null) {
                        Categorie categorie = categorieRepository.findById(categorieId)
                                        .orElseThrow(() -> new NotFoundException(
                                                        "Categorie not found with id: " + categorieId));
                        exampleProduit.setCategorie(categorie);
                }
        ...
        public List<ProduitDTO> findByCooperative(Long cooperativeId) {
                ExampleMatcher exampleMatcher = ExampleMatcher.matching()
                                .withIgnoreCase()
                                .withStringMatcher(ExampleMatcher.StringMatcher.CONTAINING);
        ...
        private ProduitDTO mapToDTO(final Produit produit, final ProduitDTO produitDTO) {
                ...
                // produitDTO.setClients(produit.getClients());
